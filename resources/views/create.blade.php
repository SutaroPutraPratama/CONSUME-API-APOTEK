...
<nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-20 border-b-2">
  ...
  <div class="container w-full flex justify-center mt-6"> 
    ...
    @endif
    <form class="w-1/2" action="/data/store" method="POST">
      @csrf
      ...
      <div class="mb-6" data-aos="fade-left" data-aos-duration="1000">
        ...
        <input type="text" name="rujukan" id="rujukan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6" data-aos="fade-left" data-aos-duration="1000">
        <label for="rumah_sakit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rumah Sakit</label>
        <input type="text" name="rumah_sakit" id="rumah_sakit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6" data-aos="fade-right" data-aos-duration="1000">
        ...
        <input type="text" name="obat" id="obat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6" data-aos="fade-left" data-aos-duration="1000">
      ...
      <div class="mb-6" data-aos="fade-right" data-aos-duration="1000">
        ...
        <input type="text" name="apoteker" id="apoteker" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
